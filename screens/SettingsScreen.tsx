...
import { View, Text, StyleSheet, ScrollView, TouchableOpacity, Switch, Modal, FlatList, Alert, ActivityIndicator } from 'react-native';
      ...
      <SafeAreaView style={{ flex: 1 }}>
        <ScrollView contentContainerStyle={styles.scrollContent}>
          <View style={styles.card}>
            ...
            <View style={styles.cardContent}>
              <TouchableOpacity style={styles.menuItem} onPress={() => setLanguageModalVisible(true)}>
                <Ionicons name="language-outline" size={22} color={theme.primary} style={styles.menuIcon} />
              ...
              <View style={styles.menuItem}>
                <Ionicons name="moon-outline" size={22} color={theme.primary} style={styles.menuIcon} />
          ...
          <View style={styles.card}>
            ...
            <View style={styles.cardContent}>
              <View style={styles.menuItem}>
                <Ionicons name="book-outline" size={22} color={theme.primary} style={styles.menuIcon} />
              ...
              <View style={styles.menuDivider} />
              <View style={styles.menuItem}>
                <Ionicons name="videocam-outline" size={22} color={theme.primary} style={styles.menuIcon} />
              ...
              <View style={styles.menuDivider} />
              <View style={styles.menuItem}>
                <Ionicons name="calendar-outline" size={22} color={theme.primary} style={styles.menuIcon} />
            ...
            <FlatList
              ...
              renderItem={({ item }) => (
                <TouchableOpacity style={styles.languageOption} onPress={() => handleLanguageSelect(item.code)}>
                  ...
                  {settings.language === item.code && <Ionicons name="checkmark-circle" size={24} color={theme.primary} />}
                </TouchableOpacity>
              )}
...
const getStyles = (theme: any) => StyleSheet.create({
  ...
  menuItemValue: { fontSize: 16, color: theme.textSecondary, fontWeight: '500', marginRight: 8 },
  menuDivider: { height: 1, backgroundColor: theme.border, marginVertical: 8 },
  modalBackdrop: { flex: 1, backgroundColor: 'rgba(0,0,0,0.6)', justifyContent: 'flex-end' },
  modalContent: { backgroundColor: theme.card, borderTopLeftRadius: 20, borderTopRightRadius: 20, padding: 20, maxHeight: '50%' },
  modalTitle: { fontSize: 20, fontWeight: 'bold', color: theme.text, marginBottom: 20, textAlign: 'center' },
  languageOption: { flexDirection: 'row', alignItems: 'center', paddingVertical: 16 },
  languageText: { fontSize: 18, color: theme.text, flex: 1 },
});
